...
package Kernel::System::ObjectSearch::Database::ObjectTagLink::General;
...
Kernel::System::ObjectSearch::Database::ObjectTagLink::General - attribute module for database object search
...
sub Sort {
    ...
    my %AttributeMapping = (
        Name       => 'LOWER(otl.name)',
        ObjectType => 'LOWER(otl.object_type)',
        ObjectID   => 'otl.object_id'
    );
