...
package Kernel::System::Installation::Migration::KIX17::Ticket::HistoryType;
...
sub Run {
    ...
    # get source data
    my $SourceData = $Self->GetSourceData(Type => 'ticket_history_type');
    ...
    foreach my $Item ( @{$SourceData} ) {
        ...
        my $MappedID = $Self->GetOIDMapping(
            ObjectType     => 'ticket_history_type',
