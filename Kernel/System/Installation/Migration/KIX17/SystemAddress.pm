...
package Kernel::System::Installation::Migration::KIX17::SystemAddress;
...
sub Run {
    ...
    # get source data
    my $SourceData = $Self->GetSourceData(Type => 'system_address');
