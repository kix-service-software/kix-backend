...
package Kernel::System::Automation::MacroAction::Ticket::ServiceSet;
...
Kernel::System::Automation::MacroAction::Ticket::ServiceSet - A module to set the ticket Service
...
create an object. Do not use it directly, instead use:
    ...
    my $ServiceSetObject = $Kernel::OM->Get('Kernel::System::Automation::MacroAction::Ticket::ServiceSet');
...
sub Run {
        ...
        )
    {
        ...
        # set ticket service
        $Success = $Kernel::OM->Get('Kernel::System::Ticket')->ServiceSet(
