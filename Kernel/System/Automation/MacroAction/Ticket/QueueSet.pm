...
package Kernel::System::Automation::MacroAction::Ticket::QueueSet;
...
Kernel::System::Automation::MacroAction::Ticket::QueueSet - A Module to move a Ticket from to a new queue

=head1 SYNOPSIS

All QueueSet functions.
...
create an object. Do not use it directly, instead use:
    ...
    my $QueueSetObject = $Kernel::OM->Get('Kernel::System::Automation::MacroAction::Ticket::QueueSet');
...
=item Run()
    ...
    my $QueueSetResult = $QueueSetActionObject->Run(
        UserID                   => 123,
...
sub Run {
    ...
    {
        $Success = $Kernel::OM->Get('Kernel::System::Ticket')->QueueSet(
