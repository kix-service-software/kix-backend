...
sub Describe {
    ...
    $Self->AddOption(
        ...
        Description => Kernel::Language::Translatable('An attachment object containing the attributes "Filename", "ContentType" and "Content" generated by the macro action "AssembleObject".'),
        Required    => 0,
    );
    $Self->AddOption(
...
sub Run {
    ...
    foreach my $ID ( 1..5 ) {
        ...
        push @Attachments, $Param{Config}->{"AttachmentObject$ID"}->AsObject();
    }
