...
Kernel::System::Automation::MacroAction::Ticket::LockSet - A module to unlock a ticket
...
create an object. Do not use it directly, instead use:
    ...
    my $LockSetObject = $Kernel::OM->Get('Kernel::System::Automation::MacroAction::Ticket::LockSet');
...
=item Run()
    ...
    my $LockSetResult = $LockSetActionObject->Run(
        UserID                   => 123,
