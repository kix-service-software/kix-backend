...
package Kernel::System::Automation::MacroAction::Ticket::SLASet;
...
Kernel::System::Automation::MacroAction::Ticket::SLASet - A module to set the ticket SLA
...
create an object. Do not use it directly, instead use:
    ...
    my $SLASetObject = $Kernel::OM->Get('Kernel::System::Automation::MacroAction::Ticket::SLASet');
...
sub Run {
        ...
        )
    {
        ...
        # set ticket SLA
        $Success = $Kernel::OM->Get('Kernel::System::Ticket')->SLASet(
