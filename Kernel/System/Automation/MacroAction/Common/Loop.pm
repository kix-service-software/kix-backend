...
sub Describe {
    ...
    $Self->AddOption(
        ...
        Description => Kernel::Language::Translatable('A list of values to go through. Either a comma separated list or an array generated by a placeholder. If the value is undefined or an empty string, nothing is done.'),
        Required    => 0,
        Placeholder => {
            Richtext  => 0,
            Translate => 0,
