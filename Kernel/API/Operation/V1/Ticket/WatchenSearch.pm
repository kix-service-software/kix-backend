...
package Kernel::API::Operation::V1::Ticket::WatchenSearch;
...
Kernel::API::Operation::Ticket::WatchenSearch - API WatcherSearch Operation backend
...
sub Run {
    ...
    if ( IsHashRefWithData(\%Watcher) ) {
        ...
        return $Self->_Success(
            Watcher => [ map {$Watcher{$_}} sort keys %Watcher ],
        )
    }
