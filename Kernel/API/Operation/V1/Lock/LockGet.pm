# --
# Kernel/API/Operation/V1/Lock/LockGet.pm - API Lock Get operation backend
...
by using Kernel::API::Operation::V1::Lock::LockGet->new();
...
sub Run {
    ...
    if ( !$Result->{Success} ) {
        $Self->_Error(
            Code    => 'Webservice.InLockConfiguration',
