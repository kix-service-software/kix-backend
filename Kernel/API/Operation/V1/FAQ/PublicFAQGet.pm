...
package Kernel::API::Operation::V1::FAQ::PublicFAQGet;
...
Kernel::API::Operation::V1::FAQ::PublicFAQGet - API FAQ PublicFAQGet Operation backend
    ...
    for my $ItemID (@ItemIDs) {
        ...
        if ( !IsHashRefWithData( \%FAQEntry ) ) {
            ...
            $ErrorMessage = 'Could not get FAQ data'
                . ' in Kernel::API::Operation::V1::FAQ::PublicFAQGet::Run()';
