...
package Kernel::API::Operation::V1::FAQ::PublicFAQSearch;
...
Kernel::API::Operation::V1::FAQ::PublicFAQSearch - API FAQ PublicFAQSearch Operation backend
...
sub Run {
    ...
    if ( !IsArrayRefWithData( \@ViewableFAQIDs ) ) {
        ...
        my $ErrorMessage = 'Could not get FAQ data'
            . ' in Kernel::API::Operation::V1::FAQ::PublicFAQSearch::Run()';
