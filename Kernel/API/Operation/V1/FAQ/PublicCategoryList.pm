...
package Kernel::API::Operation::V1::FAQ::PublicCategoryList;
...
Kernel::API::Operation::V1::FAQ::PublicCategoryList - API FAQ PublicCategoryList Operation backend
...
sub Run {
    ...
    if ( !IsHashRefWithData($CategoryTree) ) {
        ...
        my $ErrorMessage = 'Could not get category data'
            . ' in Kernel::API::Operation::V1::FAQ::PublicCategoryList::Run()';
