# --
# Kernel/GenericInterface/Operation/User/Common.pm - User common operation functions
...
Kernel::GenericInterface::Operation::User::Common - Base class for all User Operations
