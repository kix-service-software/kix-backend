# --
# Kernel/API/Operation/V1/SystemAddress/SystemAddressGet.pm - API SystemAddress Get operation backend
...
by using Kernel::API::Operation::V1::SystemAddress::SystemAddressGet->new();
