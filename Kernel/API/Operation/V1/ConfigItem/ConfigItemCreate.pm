...
package Kernel::API::Operation::V1::ConfigItem::ConfigItemCreate;
...
Kernel::API::Operation::V1::ConfigItem::ConfigItemCreate - API ConfigItem ConfigItemCreate Operation backend
...
sub new {
    ...
    $Self->{Config} = $Kernel::OM->Get('Kernel::Config')->Get('API::Operation::V1::ConfigItemCreate');
