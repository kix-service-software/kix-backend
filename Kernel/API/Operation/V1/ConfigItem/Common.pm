...
package Kernel::API::Operation::V1::ConfigItem::Common;
...
Kernel::API::Operation::V1::ConfigItem::Common - Base class for all CI Operations
    ...
    if ( !IsHashRefWithData($Webservice) ) {
        return {
            ...
            ErrorMessage =>
                ...
                . ' in Kernel::API::Operation::V1::ConfigItem::Common::new()',
        };
    }
