...
package Kernel::API::Operation::V1::ConfigItem::ConfigItemDelete;
...
Kernel::API::Operation::V1::ConfigItem::ConfigItemDelete - API Configuration Item Delete Operation backend
...
sub new {
    ...
    $Self->{Config} = $Kernel::OM->Get('Kernel::Config')->Get('API::Operation::V1::ConfigItemDelete');
    ...
    for my $ConfigItemID (@ConfigItemIDs) {
        ...
        if ( !$DeleteSuccess ) {
            ...
            $ErrorMessage = 'Could not delete ConfigItem ID ' . $ConfigItemID
                . ' in Kernel::API::Operation::V1::ConfigItem::ConfigItemDelete::Run()';
