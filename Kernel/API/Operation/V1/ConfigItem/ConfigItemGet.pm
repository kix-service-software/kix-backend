# --
# Kernel/GenericInterface/Operation/ConfigItem/ConfigItemGetBIS.pm - GenericInterface Configuration Item Get operation backend
# original Copyright (C) 2001-2015 OTRS AG, http://otrs.com/
# BIS-Extensions Copyright (C) 2006-2015 c.a.p.e. IT GmbH, http://www.cape-it.de
#
# written/edited by:
...
package Kernel::GenericInterface::Operation::ConfigItem::ConfigItemGetBIS;
...
Kernel::GenericInterface::Operation::ConfigItem::ConfigItemGetBIS - GenericInterface Configuration Item Get Operation backend
...
#    $Self->{OperationName} = 'ConfigItemGet';
    $Self->{OperationName} = 'ConfigItemGetBIS';
# EO BIS-capeIT
...
#                . ' in Kernel::GenericInterface::Operation::ConfigItem::ConfigItemGet::Run()';
            $ErrorMessage = 'Could not get ConfigItem data'
                . ' in Kernel::GenericInterface::Operation::ConfigItem::ConfigItemGetBIS::Run()';
# EO BIS-capeIT
...
# BIS-capeIT
# set create and change attributes correctly
        foreach my $Key (qw(CreateTime CreateBy ChangeTime ChangeBy)) {
            $Version->{$Key} = $ConfigItem->{$Key};
        }
# EO BIS-capeIT
