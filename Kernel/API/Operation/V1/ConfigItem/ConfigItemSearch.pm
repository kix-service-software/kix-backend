# --
# Kernel/GenericInterface/Operation/ConfigItem/ConfigItemSearchBIS.pm - GenericInterface ConfigItem ConfigItemSearch operation backend
...
package Kernel::GenericInterface::Operation::ConfigItem::ConfigItemSearchBIS;
...
Kernel::GenericInterface::Operation::ConfigItem::ConfigItemSearchBIS - GenericInterface ConfigItem ConfigItemSearch Operation backend
...
#    $Self->{OperationName} = 'ConfigItemSearch';
    $Self->{OperationName} = 'ConfigItemSearchBIS';
# EO BIS-capeIT
...
#                "$Self->{OperationName}: ConfigItem->Class parameter is missing!",
            ErrorMessage =>
                "$Self->{OperationName}: Class parameter is missing!",
# EO BIS-capeIT
        );
    }
...
#                    "$Self->{OperationName}: Structure for ConfigItem->InciStates is not correct!",
                ErrorMessage =>
                    "$Self->{OperationName}: Structure for InciStates is not correct!",
# EO BIS-capeIT
            );
        }
