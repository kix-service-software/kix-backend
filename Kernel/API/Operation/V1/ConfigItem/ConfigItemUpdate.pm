...
package Kernel::API::Operation::V1::ConfigItem::ConfigItemUpdate;
...
use base qw(
    ...
    Kernel::API::Operation::V1::ConfigItem::Common
);
...
Kernel::API::Operation::V1::ConfigItem::ConfigItemUpdate - API ConfigItem ConfigItemUpdate Operation backend
...
sub new {
    ...
    $Self->{Config} = $Kernel::OM->Get('Kernel::Config')->Get('API::Operation::V1::ConfigItemUpdate');
    ...
    if ( !$Param{Data}->{ReplaceExistingData} || !defined $ConfigItem->{CIXMLData} ) {
        ...
        if ( !IsHashRefWithData($Version) ) {
            ...
            my $ErrorMessage = 'Could not get ConfigItem data'
                . ' in Kernel::API::Operation::V1::ConfigItem::ConfigItemUpdate::Run()';
