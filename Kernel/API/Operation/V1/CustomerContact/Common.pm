# --
# Kernel/GenericInterface/Operation/CustomerUser/Common.pm - CustomerUser common operation functions
...
package Kernel::API::Operation::V1::CustomerUser::Common;
...
Kernel::API::Operation::V1::CustomerUser::Common - Base class for all CustomerUser Operations
    ...
    if ( !IsHashRefWithData($Webservice) ) {
        return {
            ...
            ErrorMessage =>
                ...
                . ' in Kernel::API::Operation::V1::CustomerUser::Common::new()',
        };
    }
