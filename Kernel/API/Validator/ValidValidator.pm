...
package Kernel::API::Validator::ValidValidator;
...
Kernel::API::Validator::ValidValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'ValidID' ) {
        ...
        return $Self->_Error(
            ...
            Message => "ValidValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
