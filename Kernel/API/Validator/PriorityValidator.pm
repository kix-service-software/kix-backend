...
package Kernel::API::Validator::PriorityValidator;
...
Kernel::API::Validator::PriorityValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'PriorityID' ) {
        $Found = $Kernel::OM->Get('Kernel::System::Priority')->PriorityLookup(
        ...
        return $Self->_Error(
            ...
            Message => "PriorityValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
