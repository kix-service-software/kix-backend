...
package Kernel::API::Validator::StateValidator;
...
Kernel::API::Validator::StateValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'StateID' ) {
        ...
        return $Self->_Error(
            ...
            Message => "StateValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
