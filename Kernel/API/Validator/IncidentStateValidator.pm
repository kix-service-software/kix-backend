...
package Kernel::API::Validator::IncidentStateValidator;
...
Kernel::API::Validator::IncidentStateValidator - validator module
...
sub Validate {
    ...
    my $Found;
    if ( $Param{Attribute} eq 'IncidentStateID' ) {
        ...
        return $Self->_Error(
            ...
            Message => "IncidentStateValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
