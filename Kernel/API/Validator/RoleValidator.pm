...
package Kernel::API::Validator::RoleValidator;
...
Kernel::API::Validator::RoleValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'RoleID' ) {
        $Found = $Kernel::OM->Get('Role')->RoleLookup(
        ...
        return $Self->_Error(
            ...
            Message => "RoleValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
