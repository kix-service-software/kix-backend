...
package Kernel::API::Validator::ServiceValidator;
...
Kernel::API::Validator::ServiceValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'ServiceID' ) {
        ...
        return $Self->_Error(
            ...
            Message => "ServiceValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
