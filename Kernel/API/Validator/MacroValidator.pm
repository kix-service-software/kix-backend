...
package Kernel::API::Validator::MacroValidator;
...
Kernel::API::Validator::MacroValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'MacroID' ) {
        $Found = $Kernel::OM->Get('Kernel::System::Automation')->MacroLookup(
        ...
        return $Self->_Error(
            ...
            Message => "MacroValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
