...
package Kernel::API::Validator::TypeValidator;
...
Kernel::API::Validator::TypeValidator - validator module
...
create an object.
    ...
    my $ValidatorObject = Kernel::API::Validator::TypeValidator->new(
