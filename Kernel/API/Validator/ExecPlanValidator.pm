...
package Kernel::API::Validator::ExecPlanValidator;
...
Kernel::API::Validator::ExecPlanValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'ExecPlanID' ) {
        ...
        return $Self->_Error(
            ...
            Message => "ExecPlanValidator: cannot validate attribute $Param{Attribute}!",
        );
    }
