...
package Kernel::API::Validator::JobRunValidator;
...
Kernel::API::Validator::JobRunValidator - validator module
...
sub Validate {
    ...
    if ( $Param{Attribute} eq 'RunID' ) {
        my %JobRun = $Kernel::OM->Get('Kernel::System::Automation')->JobRunGet(
