...
my $ValidData = {
    DeploymentStateID => $ItemData->{ItemID},
};

my $InvalidData = {
    DeploymentStateID => '99999999999999999'
};

# validate valid DeploymentStateID
my $Result = $ValidatorObject->Validate(
    Attribute => 'DeploymentStateID',
    Data      => $ValidData,
);
...
# validate invalid DeploymentStateID
