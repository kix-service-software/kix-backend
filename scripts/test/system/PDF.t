...
$TableCalculate{1}{CellData}[0][0]{Content}
    = "Welcome to KIX!\n\nthank you for installing KIX.\n\nYou will find updates and patches at http://www.kixdesk.com/. Online\ndocumentation is available at http://git.kixdesk.com/.\n\n\nYour KIX Team\n\n    Manage your communication!";
...
my $FileContent1 = $MainObject->FileRead(
    Location => $Home . '/scripts/test/system/sample/PDF/PDF-test1-iso-8859-1.txt',
);
...
my $FileContent2 = $MainObject->FileRead(
    Location => $Home . '/scripts/test/system/sample/PDF/PDF-test1-utf-8.txt',
);
...
my $FileContent3 = $MainObject->FileRead(
    Location => $Home . '/scripts/test/system/sample/PDF/PDF-test2-utf-8.txt',
);
