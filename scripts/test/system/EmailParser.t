...
# test #1
my @Array = ();
open( my $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test1.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #3
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test3.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #4
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test4.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #5
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test5.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #6
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test6.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #7
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test7.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #8
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test8.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #9
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test9.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #10
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test10.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #11
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test11.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #12
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test12.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #13
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test13.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #14
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test14.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #15
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test16.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #17
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test19.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #20
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test20.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #21
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test21.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #22
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/PostMaster-Test22.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
...
# test #23
@Array = ();
open( $IN, "<", "$Home/scripts/test/system/sample/EmailParser/UTF-7.box" );    ## no critic
while (<$IN>) {
    push( @Array, $_ );
}
close($IN);
