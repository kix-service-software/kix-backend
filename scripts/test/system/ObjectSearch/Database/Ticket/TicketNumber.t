...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(st.tn) = \'test\'' : 'st.tn = \'test\''
            ]
        }
    },
    {
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(st.tn) IN (\'test\')' : 'st.tn IN (\'test\')'
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(st.tn) NOT IN (\'test\')' : 'st.tn NOT IN (\'test\')'
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(st.tn) LIKE \'test%\'' : 'st.tn LIKE \'test%\''
            ]
        }
    },
    {
