...
# activate BasePermissionModule Owner
$Kernel::OM->Get('Config')->Set(
    Key   => 'Ticket::BasePermissionModule###Owner',
    Value => {
        Module => 'KIXPro::Kernel::System::Ticket::PermissionModule::Owner'
    }
);
...
my @GetPermissionDefTests = (
    ...
    },
    {
        ...
        Expected  => {
            ...
            OrderBy => [],
            Select  => [],
            Where   => [ "(1=0 OR st.user_id = $UserID2)" ]
        }
    },
    {
        ...
        Expected  => {
            ...
            OrderBy => [],
            Select  => [],
            Where   => [ "(st.queue_id IN ($QueueID1) OR st.user_id = $UserID3)" ]
        }
    }
);
