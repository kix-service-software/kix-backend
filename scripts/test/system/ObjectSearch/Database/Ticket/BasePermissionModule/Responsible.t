...
# activate BasePermissionModule Responsible
$Kernel::OM->Get('Config')->Set(
    Key   => 'Ticket::BasePermissionModule###Responsible',
    Value => {
        Module => 'KIXPro::Kernel::System::Ticket::PermissionModule::Responsible'
    }
);
...
my @GetPermissionDefTests = (
    ...
    },
    {
        ...
        Expected  => {
            ...
            OrderBy => [],
            Select  => [],
            Where   => [ "(1=0 OR st.responsible_user_id = $UserID2)" ]
        }
    },
    {
        ...
        Expected  => {
            ...
            OrderBy => [],
            Select  => [],
            Where   => [ "(st.queue_id IN ($QueueID1) OR st.responsible_user_id = $UserID3)" ]
        }
    }
);
...
my @IntegrationSearchTests = (
    ...
    {
        Name     => 'Search: Field Fulltext / Operator LIKE / UserID $UserID2 / Result $TicketID2',
        Search   => {
            'AND' => [
                {
                    Field    => 'Fulltext',
