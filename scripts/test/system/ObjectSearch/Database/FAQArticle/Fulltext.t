...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? '(LOWER(f.f_number) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_subject) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_keywords) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_field1) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_field2) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_field3) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_field4) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_field5) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\' OR LOWER(f.f_field6) LIKE LOWER(\'%Test%\') ESCAPE \'' . $Escape . '\') ' : '(f.f_number LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_subject LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_keywords LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_field1 LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_field2 LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_field3 LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_field4 LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_field5 LIKE \'%Test%\' ESCAPE \'' . $Escape . '\' OR f.f_field6 LIKE \'%Test%\' ESCAPE \'' . $Escape . '\') '
            ]
        }
    },
    {
