...
my @GetOperationTests = (
    ...
    },
    {
        ...
        Expected  => {
            ...
            'Where' => [
                $CaseSensitive
                    ? '(LOWER(test) LIKE \'%' . $QuoteSingle . '\'' . $QuoteSemicolon . ';select%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%%%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%from%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%mail\\_account' . $QuoteSemicolon . ';select%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%st.id%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%from%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%ticket%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%where%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%title%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%=%\' ESCAPE \'' . $Escape . '\')  AND (LOWER(test) LIKE \'%' . $QuoteSingle . '\'test%\' ESCAPE \'' . $Escape . '\') '
                    : '(test LIKE \'%' . $QuoteSingle . '\'' . $QuoteSemicolon . ';select%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%%%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%from%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%mail\\_account' . $QuoteSemicolon . ';select%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%st.id%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%from%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%ticket%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%where%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%title%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%=%\' ESCAPE \'' . $Escape . '\')  AND (test LIKE \'%' . $QuoteSingle . '\'test%\' ESCAPE \'' . $Escape . '\') '
            ]
        }
    },
    {
