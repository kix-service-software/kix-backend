...
my $AttributeModule = 'Kernel::System::ObjectSearch::Database::ObjectTagLink::General';
...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.name) = \'test\'' : 'otl.name = \'test\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.name) = \'\'' : 'otl.name = \'\''
            ]
        }
    },
    {
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.name) IN (\'test\')' : 'otl.name IN (\'test\')'
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.name) NOT IN (\'test\')' : 'otl.name NOT IN (\'test\')'
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.name) LIKE \'test%\'' : 'otl.name LIKE \'test%\''
            ]
        }
    },
    {
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.object_type) = \'test\'' : 'otl.object_type = \'test\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.object_type) = \'\'' : 'otl.object_type = \'\''
            ]
        }
    },
    {
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.object_type) IN (\'test\')' : 'otl.object_type IN (\'test\')'
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.object_type) NOT IN (\'test\')' : 'otl.object_type NOT IN (\'test\')'
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? 'LOWER(otl.object_type) LIKE \'test%\'' : 'otl.object_type LIKE \'test%\''
            ]
        }
    },
    {
...
my @SortTests = (
    ...
    },
    {
        ...
        Attribute => 'Name',
        Expected  => {
            'Select'  => ['LOWER(otl.name)'],
            'OrderBy' => ['LOWER(otl.name)']
        }
    },
    {
        ...
        Expected  => {
            'Select'  => ['LOWER(otl.object_type)'],
            'OrderBy' => ['LOWER(otl.object_type)']
        }
    },
    {
        ...
        Attribute => 'ObjectID',
        Expected  => {
            'Select'  => ['otl.object_id'],
            'OrderBy' => ['otl.object_id']
        }
    }
);
...
my @IntegrationSearchTests = (
    ...
    },
    {
        ...
        Expected => [$ObjectTagID1,$ObjectTagID3]
    },
    {
        ...
        Expected => [$ObjectTagID1,$ObjectTagID2,$ObjectTagID3]
    },
    {
        Name     => 'Search: Field Name / Operator IN / Value [$ObjectTagID1,$ObjectTagID3]',
        Search   => {
            'AND' => [
                {
                    Field    => 'Name',
    ...
    {
        Name     => 'Search: Field ObjectType / Operator IN / Value [$ObjectTagID1,$ObjectTagID3]',
        Search   => {
            'AND' => [
                {
                    Field    => 'ObjectType',
    ...
    },
    {
        ...
        Expected => [$ObjectTagID1,$ObjectTagID2]
    },
    {
    ...
    },
    {
        ...
        Expected => [$ObjectTagID2,$ObjectTagID3]
    }
);
...
my @IntegrationSortTests = (
    ...
    },
    {
        ...
        Expected => [$ObjectTagID3,$ObjectTagID2,$ObjectTagID1]
    },
    {
