...
my $AttributeModule = 'Kernel::System::ObjectSearch::Database::ObjectTagLink::Editor';
...
my @SortTests = (
    ...
    },
    {
        ...
        Expected  => {
            'Join'    => [
                'INNER JOIN users otlcru ON otlcru.id = otl.create_by',
                'LEFT OUTER JOIN contact otlcruc ON otlcruc.user_id = otlcru.id'
            ],
            'Select'  => ['LOWER(otlcruc.lastname)','LOWER(otlcruc.firstname)','LOWER(otlcru.login)'],
    ...
    },
    {
        ...
        Expected  => {
            'Join'    => [
                'INNER JOIN users otlchu ON otlchu.id = otl.change_by',
                'LEFT OUTER JOIN contact otlchuc ON otlchuc.user_id = otlchu.id'
            ],
            'Select'  => ['LOWER(otlchuc.lastname)','LOWER(otlchuc.firstname)','LOWER(otlchu.login)'],
...
my @IntegrationSortTests = (
    ...
    },
    {
        ...
        Expected => $OrderByNull eq 'LAST' ? [$ObjectTagID1,$ObjectTagID2,$ObjectTagID3] : [$ObjectTagID3,$ObjectTagID1,$ObjectTagID2]
    },
    {
    ...
    },
    {
        ...
        Expected => $OrderByNull eq 'LAST' ? [$ObjectTagID3,$ObjectTagID2,$ObjectTagID1] : [$ObjectTagID2,$ObjectTagID1,$ObjectTagID3]
    },
    {
