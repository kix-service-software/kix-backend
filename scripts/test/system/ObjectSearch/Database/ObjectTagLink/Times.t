...
my $AttributeModule = 'Kernel::System::ObjectSearch::Database::ObjectTagLink::Times';
...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                'otl.create_time = \'2014-01-01 12:00:00\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                'otl.create_time = \'2014-01-01 13:00:00\''
            ],
            'IsRelative' => 1
        }
    },
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                'otl.change_time = \'2014-01-01 12:00:00\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                'otl.change_time = \'2014-01-01 13:00:00\''
            ],
            'IsRelative' => 1
        }
    },
...
my @SortTests = (
    ...
    },
    {
        ...
        Expected  => {
            Select        => [ 'otl.create_time' ],
            OrderBy       => [ 'otl.create_time' ]
        }
    },
    {
        ...
        Expected  => {
            Select  => [ 'otl.change_time' ],
            OrderBy => [ 'otl.change_time' ]
        }
    }
);
...
$Self->IsDeeply(
    \@SecondResult,
    [$ObjectTagID1,$ObjectTagID2,$ObjectTagID3],
