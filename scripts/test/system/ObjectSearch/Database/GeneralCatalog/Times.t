...
my $AttributeModule = 'Kernel::System::ObjectSearch::Database::GeneralCatalog::Times';
...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                'gc.create_time = \'2014-01-01 12:00:00\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                'gc.create_time = \'2014-01-01 13:00:00\''
            ],
            'IsRelative' => 1
        }
    },
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                'gc.change_time = \'2014-01-01 12:00:00\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                'gc.change_time = \'2014-01-01 13:00:00\''
            ],
            'IsRelative' => 1
        }
    },
...
my @SortTests = (
    ...
    },
    {
        ...
        Expected  => {
            Select  => [ 'gc.create_time' ],
            OrderBy => [ 'gc.create_time' ]
        }
    },
    {
        ...
        Expected  => {
            Select  => [ 'gc.change_time' ],
            OrderBy => [ 'gc.change_time' ]
        }
    }
);
...
my @IntegrationSearchTests = (
    ...
    },
    {
        ...
        Expected => [@ItemIDs,$ItemID1,$ItemID3]
    },
    {
