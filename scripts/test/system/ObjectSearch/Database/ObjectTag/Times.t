...
my $AttributeModule = 'Kernel::System::ObjectSearch::Database::ObjectTag::Times';
...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                'ot.create_time = \'2014-01-01 12:00:00\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                'ot.create_time = \'2014-01-01 13:00:00\''
            ],
            'IsRelative' => 1
        }
    },
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                'ot.change_time = \'2014-01-01 12:00:00\''
            ]
        }
    },
    {
        ...
        Expected     => {
            'Where' => [
                'ot.change_time = \'2014-01-01 13:00:00\''
            ],
            'IsRelative' => 1
        }
    },
...
my @SortTests = (
    ...
    },
    {
        ...
        Expected  => {
            Select        => [ 'ot.create_time' ],
            OrderBy       => [ 'ot.create_time' ]
        }
    },
    {
        ...
        Expected  => {
            Select  => [ 'ot.change_time' ],
            OrderBy => [ 'ot.change_time' ]
        }
    }
);
