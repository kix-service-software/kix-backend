...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Join' => [
                'INNER JOIN general_catalog ciis ON ciis.id = ci.cur_inci_state_id AND ciis.general_catalog_class = \'ITSM::Core::IncidentState\''
            ],
            'Where' => [
                'ciis.name = \'Test\''
            ]
    ...
    },
    {
        ...
        Expected     => {
            'Join' => [
                'LEFT OUTER JOIN configitem_version civ on civ.configitem_id = ci.id',
                'INNER JOIN general_catalog civis ON civis.id = civ.inci_state_id AND civis.general_catalog_class = \'ITSM::Core::IncidentState\''
            ],
            'Where' => [
                'civis.name = \'Test\''
            ]
...
my @SortTests = (
    ...
    },
    {
        ...
        Expected  => {
            'Join'    => [
                'LEFT OUTER JOIN general_catalog ciis ON ciis.id = ci.cur_inci_state_id AND ciis.general_catalog_class = \'ITSM::Core::IncidentState\'',
