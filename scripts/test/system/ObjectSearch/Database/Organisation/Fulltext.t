...
my @SearchTests = (
    ...
    },
    {
        ...
        Expected     => {
            'Where' => [
                $CaseSensitive ? '(LOWER(o.name) LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR LOWER(o.number) LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR LOWER(o.street) LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR LOWER(o.city) LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR LOWER(o.zip) LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR LOWER(o.url) LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR LOWER(o.country) LIKE \'%test%\' ESCAPE \'' . $Escape . '\') ' : '(o.name LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR o.number LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR o.street LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR o.city LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR o.zip LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR o.url LIKE \'%test%\' ESCAPE \'' . $Escape . '\' OR o.country LIKE \'%test%\' ESCAPE \'' . $Escape . '\') '
            ]
        }
    }
);
