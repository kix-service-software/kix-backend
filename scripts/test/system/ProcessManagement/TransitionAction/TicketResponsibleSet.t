...
my $ModuleObject = $Kernel::OM->Get('ProcessManagement::TransitionAction::TicketResponsibleSet');
...
my @Tests = (
    ...
    },
    {
        ...
        Config => {
            ...
            Ticket => \%Ticket,
            Config => {
                ResponsibleID => '<KIX_TICKET_OwnerID>',
            },
        },
        Success => 1,
    },
    {
        ...
        Config => {
            ...
            Ticket => \%Ticket,
            Config => {
                ResponsibleID => '<KIX_TICKET_NotExisting>',
            },
        },
        Success => 0,
    },
