...
my $Filename = $Kernel::OM->Get('Main')->FilenameCleanUp(
    Filename => $Subject,
    Type     => 'Attachment',
);
...
EOF
    ...
    {
        Name  => 'Plain email, attachment with ticket number in body',
        Email => <<EOF,
Date: Thu, 21 Jun 2012 17:06:27 +0200
From: "Peter Pruchnerovic - MALL.cz" <peter.pruchnerovic\@mall.cz>
MIME-Version: 1.0
...
EOF
    ...
    {
        Name  => 'Plain email, attachment with ticket number in name',
        Email => <<EOF,
Date: Thu, 21 Jun 2012 17:06:27 +0200
From: "Peter Pruchnerovic - MALL.cz" <peter.pruchnerovic\@mall.cz>
MIME-Version: 1.0
...
EOF
    ...
    {
        Name  => 'HTML email, attachment with ticket number in body',
        Email => <<EOF,
Content-Type: multipart/alternative; boundary="Apple-Mail=_BA4B97EF-C2DC-42FB-BF6F-A71DBDC93F10"
Subject: test multipart/mixed HTML
Date: Fri, 9 Sep 2016 09:03:57 +0200
...
EOF
    ...
    {
        Name  => 'HTML email, attachment with ticket number in name',
        Email => <<EOF,
Content-Type: multipart/alternative; boundary="Apple-Mail=_BA4B97EF-C2DC-42FB-BF6F-A71DBDC93F10"
Subject: test multipart/mixed HTML
Date: Fri, 9 Sep 2016 09:03:57 +0200
...
for my $Test (@Tests) {
    my @Return;
    {
        ...
        $Kernel::OM->Get('Config')->Set(
            ...
            Value => {
                '0390-AttachmentsFilename' => {
                    Module => 'Kernel::System::PostMaster::FollowUpCheck::AttachmentsFilename',
                }
            }
        );
