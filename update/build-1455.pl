...
local $Kernel::OM = Kernel::System::ObjectManager->new(
    'Log' => {
        LogPrefix => 'framework_update-to-build-1455',
    },
);
...
# add new dynamic fields for system monitoring
_AddDynamicFields();
...
sub _GetDynamicFieldsDefinitions {
    ...
    my @DynamicFields = (
        ...
        {
            Name          => 'SysMonXAddress',
            Label         => Kernel::Language::Translatable('System Address'),
            FieldType     => 'Text',
            ObjectType    => 'Ticket',
            InternalField => 0,
            Config        => {
        ...
        {
            Name          => 'SysMonXHost',
            Label         => Kernel::Language::Translatable('System Host'),
            FieldType     => 'Text',
            ObjectType    => 'Ticket',
            InternalField => 0,
            Config        => {
        ...
        {
            Name          => 'SysMonXService',
            Label         => Kernel::Language::Translatable('System Service'),
            FieldType     => 'Text',
            ObjectType    => 'Ticket',
            InternalField => 0,
            Config        => {
        ...
        {
            Name          => 'SysMonXState',
            Label         => Kernel::Language::Translatable('System State'),
            FieldType     => 'Text',
            ObjectType    => 'Ticket',
            InternalField => 0,
            Config        => {
