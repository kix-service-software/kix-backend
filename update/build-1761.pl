...
local $Kernel::OM = Kernel::System::ObjectManager->new(
    'Log' => {
        LogPrefix => 'framework_update-to-build-1761',
    },
);
...
sub _AddNewPermissions {
    ...
    my %QueueList          = reverse $Kernel::OM->Get('Queue')->QueueList();
