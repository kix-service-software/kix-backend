...
local $Kernel::OM = Kernel::System::ObjectManager->new(
    'Log' => {
        LogPrefix => 'framework_update-to-build-1310',
    },
);
    ...
    my @NewPermissions = (
        {
            Role   => 'Agent User',
            Type   => 'Object',
            Target => '/system/config/*{SysConfigOption.AccessLevel EQ confidential}',
            Value  => 0    # -----
        },
        {
            Role   => 'Agent User',
            Type   => 'Object',
            Target => '/system/config/definitions/*{SysConfigOptionDefinition.AccessLevel EQ confidential}',
            Value  => 0    # -----
        },
